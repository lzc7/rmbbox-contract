...
import com.zipi.service.SealAutoService;
import com.zipi.service.facade.SignatureFacadeService;
import com.zipi.utils.*;
...
//	@Autowired
//	private ClaimInvestMapper claimInvestMapper;
//
//	@Autowired
//	private ClaimRepayApplyService claimRepayApplyService;
//	@Autowired
//	private ClaimProductService claimProductService;
//
//	@Autowired
//	UplanPDFUtil uplanPDFUtil;
//
//	@Autowired
//    private CapitalLendingReportUtil capitalLendingReportUtil;
//    @Autowired
//    private SellFileReportUtil sellFileReportUtil;
//    @Autowired
//    private YYAgreementReportUtil yyAgreementReportUtil;
//    @Autowired
//    private NoticeReportUtil noticeReportUtil;
//    @Autowired
//    private ClaimInvestService claimInvestService;
//    @Autowired
//    private DQAgreementReportUtil dqAgreementReportUtil;
//    @Autowired
//    private VersionThreeFileUtils versionThreeFileUtils;
//    @Autowired
//    private LoanContractUtils loanContractUtils;
//    @Autowired
//    private AssetService assetService;
//    @Autowired
//    private ProductIntroductionUtils productIntroductionUtils;
//    @Autowired
//    private SubscriptionAgreementUtils  subscriptionAgreementUtils;
    @Autowired
    private SignatureFacadeService signatureFacadeService;
//    @Autowired
//    private CoreSealFlieMapper coreSealFlieMapper;
//	@Autowired
//	private SubscriptionAgreementForExchangeUtils subscriptionAgreementForExchangeUtils;
//
//	@Autowired
//	private SubscriptionAgreementForDaLianUtils subscriptionAgreementForDaLianUtils;
//	@Autowired
//	private ClaimUtils claimUtils;
//	@Autowired
//	private SubscriptionAgreementForBaoLiUtils subscriptionAgreementForBaoLiUtils;
//	@Autowired
//	private ProductIntroductionForBaoLiUtils productIntroductionForBaoLiUtils;
//	@Autowired
//	private SubscriptionAgreementForDaLianExchangeUtils subscriptionAgreementForDaLianExchangeUtils;
//	@Autowired
//	private SubscriptionAgreementForBaoLiExchangeUtils subscriptionAgreementForBaoLiExchangeUtils;
//	@Autowired
//	private BillLoanAgreementUtil billLoanAgreementUtil;
//	@Autowired
//	private CarLoanAgreementUtil carLoanAgreementUtil;
	@Autowired
	private CreditLoanAgreementUtil creditLoanAgreementUtil;
//	@Autowired
//	private GuarantorAgreementUtil guarantorAgreementUtil;
//	@Autowired
//	private SignatureService signatureService;
	...
	public File createLoanAgreement(String investId,String loanId,String userId,SealFileType fileType) throws Exception{
		...
		//生成文件
		byte[] pdf=null;
		if(SealFileType.BillLoanAgreementForLoan.equals(fileType)||SealFileType.BillLoanAgreementForLend.equals(fileType)){
			//生成票据标
//			pdf=billLoanAgreementUtil.createFile(investId,loanId,userId,fileType);
		}else if(SealFileType.CarLoanAgreementForLoan.equals(fileType)||SealFileType.CarLoanAgreementForLend.equals(fileType)){
			//生成车贷标
//			pdf=carLoanAgreementUtil.createFile(investId,loanId,userId,fileType);
		}else if(SealFileType.CreditLoanAgreementForLend.equals(fileType)||SealFileType.CreditLoanAgreementForLoan.equals(fileType)){
			//生成信贷标
